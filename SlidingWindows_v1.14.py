...
print ("-      09/12/2022 (last update)              -")
print ("-      d.field@ecu.edu.au                    -")
print ("----------------------------------------------")
print ("                                  ")
    ...
    if LineNumber > 0:
        ...
        if windowOnly == 0:
            ...
            with open(thisScaff + '.sync') as InFile2:
                ...
                progDisp = list(range(1,100)); progDispAdj = list(range(1,100)); LineNum_sync = 0; posCounter_previous =0; posCounter=0; badSeq = 0
                countProg = int(0)
                print ("\n Processing sites...")
        ...
        if float(totalScaffSize) > 15000:
            ...
            windowList = list(range(1,int(totalFullWindows)))
