		...
		if windowOnly == 0:
			...
			with open(thisScaff + '.sync') as InFile2:
				...
				for line in InFile2:		
					OutputString = 1
					if LineNum_sync>0:
						posCounter_previous = currentPos
					...
					# Initialise counter
# 					diffCounters = (int(currentPos)-int(posCounter_previous))
					
					# This skips over unusual out of sequence positions in sync file
					# if (LineNum_sync > 0 and (diffCounters>10000 or diffCounters<0)):
# 						OutputString = 0
# 						badSeq == 1
# 						print '\n Warning - position out of sequence: '
# 						print '\n Previous site: ', posCounter_previous
# 						print '\n currentPos: ', currentPos
# 						currentPos = posCounter_previous 
# 						next
		...
		#############################
		if sitesOnly == 0:
				# print "\n Site analyses only ... next scaffold "
	# 			print " "
	# 			print " "
